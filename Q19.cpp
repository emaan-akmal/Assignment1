...
int main() {
	...
	float window1Area, window2Area, doorArea, shelfArea, wallsA, wallsB,/* ceiling,*/ totalArea, paintedArea, areaPerGallon, gallonsNeeded;
	...
	gallonsNeeded = paintedArea / areaPerGallon;
